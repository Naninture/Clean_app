                      ...
                      RaisedButton(onPressed: () {
                        showDialog(
                            ...
                            builder: (_) => NetworkGiffyDialog(
                                  image: _output[0]["confidence"] * 100 >= 80
                                      ? Lottie.network(
                                          'https://assets7.lottiefiles.com/packages/lf20_lbupw8l3.json')
                                      : Lottie.network(
                                          'https://assets10.lottiefiles.com/packages/lf20_7qcbuqgk.json'),
                                  title: Text('Result',
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontSize: 22.0,
                                          fontWeight: FontWeight.w600)),
                                  description: _output == null
                                      ? Text("")
                                      : Text(
                                          "${_output[0]["label"]}\n\n${_output[0]["confidence"] * 100}%",
                                          style: TextStyle(fontSize: 14.0),
